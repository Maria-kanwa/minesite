...
function add_header_post_support(){
    add_theme_support('post-thumbnails');
}
add_action( 'after_setup_theme', 'add_header_post_support');
...
function secondwebsite_widgets_init() {
    ...
    function test_weather_api() {
		...
		$url = 'https://api.openweathermap.org/data/2.5/weather?q=Daska,pk&appid=5e3f6dabb8cf4af28afed754bea69421';
	
	   
	
		
		$response = wp_remote_get($api_endpoint  ); // [1,2,3]
